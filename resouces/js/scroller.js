...
var RANGEHANDLER = function () {
  ...
  fn.checkScrollType = function (progress) {
    if (progress >= this.startPoint && !this.activeReverseStart && !this.activeReverseComplate && !this.complateReverseCallback && !this.activeOnStart && !this.activeOnComplate && !this.complateOnCallback) {
      return 'pass';
